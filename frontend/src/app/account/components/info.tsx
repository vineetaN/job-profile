...
const {updateProfilePic , 
  updateResume , btnLoading , updateUser
} = useAppData()
          ...
          <div className="absolute -bottom-16 left-8">
            <div className="relative group">
              <div className="w-32 h-32 rounded-full border-4 border-background overflow-hidden shadow-xl bg-background">
                <img src={user.profile_pic ? user.profile_pic : "/user.jpg"} alt=""
...
{user.role === "jobseeker" && user.resume && <div className='mt-8'>
 ...
 <NotepadText size={20} className='text-red-600'/>
    ...
    <div className="flex-1">
      ...
      <Link href={user.resume} className='text-sm text-blue-500 hover:underline'
      target='_blank'>
        View Resume PDF
      </Link>
    </div>
...
<DialogFooter>
  ...
  className="w-full h-11" type="submit">
