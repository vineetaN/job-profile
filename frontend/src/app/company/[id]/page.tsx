...
const udateModalRef = useRef<HTMLButtonElement>(null)
        ...
        <div className="bg-blue-600 border-b p-6">
            <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                <p className="text-sm opacity-70 text-white">{company.jobs?.length || 0}
                    active job{company.jobs?.length !== 1 ? "s" : ""}
                </p>
            </div>
        </div>
...
<Briefcase size={16}/> Job Title
        ...
        <Input id="title" type="text" placeholder = "Enter Job Title" className="h-11" value={title}
...
<FileText size={16}/> Description
        ...
        <Input id="description" type="text" placeholder = "Enter Description" className="h-11" value={description}
...
<DollarSign size={16}/> Salary
        ...
        <Input id="salary" type="number" placeholder = "Enter salary" className="h-11 cursor-pointer" 
        value={salary}
...
<Users size={16}/> Openings
        ...
        <Input id="openings" type="number" placeholder = "Eg. 5" className="h-11 cursor-pointer" 
        value={openings}
...
<MapPin size={16}/> Location
        ...
        <Input id="location" type="text" placeholder = "Enter location" className="h-11 cursor-pointer" 
        value={location}
    ...
    <div className="space-y-4">
        {company.jobs.map((j) => (
            <div key={j.job_id} className='p-5 rounded-lg border-2 hover:border-blue-500 transition-all bg-background'>
                <div className="flex items-start jutify-between gap-4 flex-wrap">
...
<span className={`text-xs px-3 py-1 rounded-full flex items-center gap-1 ${j.is_active ? 
...
{
    j.is_active? (<CheckCircle size={14}/>) :
    (
        <XCircle size={14}/>
    )
